...
const About = () => {
    ...
    useEffect(() => {
        gsap.to(".about__text-animate", {
            ...
            ease: "power2.inOut",
            scrollTrigger: {
                trigger: ".about__header-wrapper h1"
            }
        },0.25);

        gsap.to(".about__animate-left", {
            x: 0,
            opacity: 1,
            duration: 0.6,
            ease: "power4.out",
            scrollTrigger: {
                trigger: ".about__animate-left"
            }
        });

        gsap.to(".about__text-wrapper", {
            x: 0,
            opacity: 1,
            duration: 0.9,
            ease: "power4.inOut",
    ...
    <>
        ...
        <div className="about__features-container">
            ...
            <div className="about__text-section">
                <div className="about__text-wrapper about__online-tracking">
                ...
                <div className="about__text-wrapper about__dv-maker">
                    <div className="about__feature-icon">
                ...
                <div className="about__text-wrapper about__requirement-validation">
                    <div className="about__feature-icon">
