...
const FrequentSummaryCard = ({ accounttype, count }) => {
  return (
    <div className="adminpage__accountcard-status h-[4.063rem] w-[11.05rem] flex justify-around items-center bg-white">
...
const Accountcount = () => {
  ...
  return (
    <div className="adminpage__accounttotal-status w-full min-h-full flex flex-wrap justify-start gap-1">
      {data.map((item, index) => (
        <FrequentSummaryCard
          key={index}
