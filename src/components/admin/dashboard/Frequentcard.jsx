...
const FrequentSummaryCard = ({ label, icon }) => {
  return (
    <div className="h-full w-[8.875rem] flex justify-center bg-white">
    <div className="adminpage__frequent-summary-card h-full w-[8.75rem] flex flex-col justify-evenly items-center">
...
const Frequentcard = () => {
  ...
  return (
    <div className="adminpage__summarycard-container w-[28.9rem] h-full flex flex-col justify-center rounded-lg p-4 shadow gap-2">
      ...
      <div className="adminpage__card-bot w-full h-full">
        <div className="adminpage__card-bot-container w-full h-full flex items-center justify-between">
          {data.map((item, index) => (
            <FrequentSummaryCard 
              key={index} 
              label={item.label} 
